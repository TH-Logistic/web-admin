    ...
    return (
        <div>
            <div className='flex items-center p-6'>
                <img src={CloseIcon} alt="close" className='w-4 mr-4' />
            ...
            <div className='my-4 mx-14'>
                ...
                <form className='flex flex-col gap-4 mt-4'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <input type='text' name='product-base-price' className='py-1 px-4 outline-border-color rounded-md border-[1px] flex-1' placeholder='Base price (kg/km)' />
                    </div>

                    <div className='flex items-center'>
                        <label htmlFor='product-type' className='mr-4 basis-1/6'>Product Type</label>

                        <select name="product-type" className='py-1 px-4 outline-border-color rounded-md border-[1px] flex-1' placeholder='Product type'>
